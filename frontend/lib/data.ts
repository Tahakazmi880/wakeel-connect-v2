...
export const PRACTICE_AREAS: PracticeArea[] = [
  ...
  { slug: "civil-law", nameEn: "Civil Litigation", nameUr: "دیوانی مقدمات", description: "Civil suits, injunctions, damages and appeals." },
...
export const LAWYERS: Lawyer[] = [
  ...
  // ============ REAL LAWYERS — Shams Law Chamber team (shamslawchamber.com) ============
  // Added 2026-09-23 from the chamber's Our Team page. CONFIRMED from site:
  // names, titles, education (where listed), practice areas, office cities.
  // Office grouping (Karachi / Hyderabad / Sukkur) follows the page's three
  // team sections — INFERRED, needs client confirmation.
  // PLACEHOLDER: consultation fees (Senior Associate Rs. 5,000, Associate
  // Rs. 3,000 — suggested defaults), years of experience except where the
  // site states them, individual bar council numbers. Photos not yet
  // supplied — initials avatars show until real photos are added.
  {
    slug: "safia-shams",
    photo: "",
    ...
    experience: [
      { title: "Senior Associate", org: "Shams Law Chamber, Karachi", status: "present" },
      { title: "Assistant Registrar", org: "Office of the Ombudsman (Sindh)", status: "former" },
      { title: "Visiting Faculty", org: "Shah Abdul Latif University, Khairpur", status: "former" },
    ],
    rating: 5.0,
    reviewCount: 0,
    totalConsultations: 0,
  ...
  },
  {
    ...
    barCouncilNo: "Available on request",
    courts: ["Sindh High Court", "City Courts Karachi"],
    practiceAreaSlugs: ["family-law", "constitutional-law"],
    langCodes: ["ur", "en"],
    chamberName: "Shams Law Chamber",
    chamberAddress: "Mezzanine Floor, Building No. 28-C, Old Sunset Boulevard, DHA Phase II, Karachi",
    education: [{ degree: "LL.B (Hons.)", institution: "", year: 0 }],
  ...
  },
  {
    ...
    barCouncil: "Sindh Bar Council",
    barCouncilNo: "Available on request",
    courts: ["City Courts Karachi"],
    practiceAreaSlugs: ["criminal-law", "civil-law"],
    langCodes: ["ur", "en"],
    chamberName: "Shams Law Chamber",
    chamberAddress: "Mezzanine Floor, Building No. 28-C, Old Sunset Boulevard, DHA Phase II, Karachi",
    education: [{ degree: "LL.B (Hons.), SZABUL", institution: "SZABUL", year: 0 }],
    services: [
    ...
    experience: [
      { title: "Associate", org: "Shams Law Chamber, Karachi", status: "present" },
    ],
    rating: 5.0,
    reviewCount: 0,
    totalConsultations: 0,
  ...
  },
  {
    ...
    barCouncilNo: "Available on request",
    courts: ["City Courts Karachi"],
    practiceAreaSlugs: ["criminal-law", "corporate-law"],
    langCodes: ["ur", "en"],
    chamberName: "Shams Law Chamber",
    chamberAddress: "Mezzanine Floor, Building No. 28-C, Old Sunset Boulevard, DHA Phase II, Karachi",
    education: [{ degree: "LL.B, University of London", institution: "University of London", year: 0 }],
    services: [
      { nameEn: "Online Consultation (30 min)", nameUr: "آن لائن مشاورت", feePaisa: 300000 },
      { nameEn: "Chamber Meeting (30 min)", nameUr: "چیمبر ملاقات", feePaisa: 300000 },
    ],
  ...
  },
  {
    ...
    barCouncilNo: "Available on request",
    courts: ["City Courts Karachi"],
    practiceAreaSlugs: ["criminal-law", "banking-finance"],
    langCodes: ["ur", "en"],
    chamberName: "Shams Law Chamber",
    chamberAddress: "Mezzanine Floor, Building No. 28-C, Old Sunset Boulevard, DHA Phase II, Karachi",
    education: [{ degree: "LL.B (Hons.), SZABSOL, SALU Khairpur", institution: "SALU Khairpur", year: 0 }],
    services: [
      { nameEn: "Online Consultation (30 min)", nameUr: "آن لائن مشاورت", feePaisa: 300000 },
      { nameEn: "Chamber Meeting (30 min)", nameUr: "چیمبر ملاقات", feePaisa: 300000 },
    ],
  ...
  },
  {
    ...
    experience: [
      { title: "Senior Associate", org: "Shams Law Chamber, Hyderabad", status: "present" },
    ],
    rating: 5.0,
    reviewCount: 0,
    totalConsultations: 0,
  ...
  },
  {
    ...
    barCouncilNo: "Available on request",
    courts: ["Sindh High Court", "District Courts Hyderabad"],
    practiceAreaSlugs: ["civil-law", "labour-law"],
    langCodes: ["ur", "en"],
    chamberName: "Shams Law Chamber",
    chamberAddress: "Labaik Plaza, Near Bismillah CNG, Wadhu Wah Main National Highway, Hyderabad",
    education: [],
  ...
  },
  {
    ...
    experience: [
      { title: "Associate", org: "Shams Law Chamber, Hyderabad", status: "present" },
    ],
    rating: 5.0,
    reviewCount: 0,
    totalConsultations: 0,
  ...
  },
  {
    ...
    chamberAddress: "Labaik Plaza, Near Bismillah CNG, Wadhu Wah Main National Highway, Hyderabad",
    education: [
      { degree: "BPA", institution: "", year: 0 },
      { degree: "LL.B, Shah Abdul Latif University, Khairpur", institution: "SALU Khairpur", year: 0 },
    ],
    services: [
      { nameEn: "Online Consultation (30 min)", nameUr: "آن لائن مشاورت", feePaisa: 300000 },
      { nameEn: "Chamber Meeting (30 min)", nameUr: "چیمبر ملاقات", feePaisa: 300000 },
  ...
  },
  {
    ...
    barCouncil: "Sindh Bar Council",
    barCouncilNo: "Available on request",
    courts: ["Sindh High Court", "District Courts Sukkur"],
    practiceAreaSlugs: ["criminal-law", "civil-law"],
    langCodes: ["ur", "en"],
    chamberName: "Shams Law Chamber",
    chamberAddress: "Mushtaq Surhio Building, Workshop Road, Sukkur",
    education: [
      { degree: "BA", institution: "", year: 0 },
      { degree: "LL.B", institution: "", year: 0 },
    ],
    services: [
      { nameEn: "Online Consultation (30 min)", nameUr: "آن لائن مشاورت", feePaisa: 300000 },
    ...
    experience: [
      { title: "Associate", org: "Shams Law Chamber, Sukkur", status: "present" },
    ],
    rating: 5.0,
    reviewCount: 0,
    totalConsultations: 0,
  ...
  },
  {
    ...
    chamberAddress: "Mushtaq Surhio Building, Workshop Road, Sukkur",
    education: [
      { degree: "B.A. LL.B (Hons.), SZABUL", institution: "SZABUL", year: 0 },
      { degree: "LL.M. (final year), University of Sindh", institution: "University of Sindh", year: 0 },
    ],
    services: [
      { nameEn: "Online Consultation (30 min)", nameUr: "آن لائن مشاورت", feePaisa: 300000 },
      { nameEn: "Chamber Meeting (30 min)", nameUr: "چیمبر ملاقات", feePaisa: 300000 },
  ...
  },
  {
    ...
    barCouncilNo: "Available on request",
    courts: ["Sindh High Court", "District Courts Sukkur"],
    practiceAreaSlugs: ["constitutional-law", "civil-law"],
    langCodes: ["ur", "en"],
    chamberName: "Shams Law Chamber",
    chamberAddress: "Mushtaq Surhio Building, Workshop Road, Sukkur",
    education: [{ degree: "LL.B (Hons.)", institution: "", year: 0 }],
